...
Main.main = function() {
	kha_System.start(new kha_SystemOptions("Project",1024,768,null,null),function(_) {
		kha_Assets.loadEverything(function() {
			...
			kha_System.notifyOnFrames($bind(Project1,Project1.render));
		});
	});
};
Math.__name__ = true;
var Project = function() {
	this.image = kha_Assets.images.test;
};
...
Project.prototype = {
	...
	,render: function(frames) {
		var graphic = frames[0].get_g2();
		graphic.begin();
		graphic.drawImage(this.image,30,30);
		graphic.end();
	}
	,__class__: Project
};
...
var kha__$Assets_ImageList = function() {
	this.names = ["test"];
	this.testDescription = { name : "test", original_height : 400, original_width : 600, files : ["test.jpg"], type : "image"};
	this.testName = "test";
	this.test = null;
};
...
kha__$Assets_ImageList.prototype = {
	...
	,testLoad: function(done,failure) {
		var tmp;
		if(failure != null) {
			tmp = failure;
		} else {
			var f = haxe_Log.trace;
			var infos = { fileName : "kha/internal/AssetsBuilder.hx", lineNumber : 132, className : "kha._Assets.ImageList", methodName : "testLoad"};
			tmp = function(v) {
				f(v,infos);
			};
		}
		kha_Assets.loadImage("test",function(image) {
			done();
		},tmp,{ fileName : "kha/internal/AssetsBuilder.hx", lineNumber : 132, className : "kha._Assets.ImageList", methodName : "testLoad"});
	}
	,testUnload: function() {
		this.test.unload();
		this.test = null;
